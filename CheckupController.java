...
public class CheckupController {
	...
	public ResponseEntity<Checkup> createCheckup(@Valid @RequestBody Checkup checkup){
		...
		Checkup createdCheckup = checkupService.saveCheckup(checkup);
	...
	@PostMapping("/update")
	public ResponseEntity<Checkup> updateCheckup(@Valid @RequestBody Checkup checkup){
		
		Checkup updatedCheckup  = checkupService.updateCheckup(checkup);
		
		return new ResponseEntity<Checkup>(updatedCheckup,HttpStatus.CREATED);
	}
